...
images_database_initialiser_name=${cr}peerprep_room_service_database_initialiser
...
# Expired room deleter image
images_expired_room_deleter_name=${cr}peerprep_room_service_expired_room_deleter
